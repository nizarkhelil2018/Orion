...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'discutea.forum.form.remove.category' => 'getDiscutea_Forum_Form_Remove_CategoryService',
            'discutea.forum.form.remove.forum' => 'getDiscutea_Forum_Form_Remove_ForumService',
            'discutea.forum.pagin' => 'getDiscutea_Forum_PaginService',
            ...
            'forum.listener.dropauser' => 'getForum_Listener_DropauserService',
            ...
            'topic.listener.updatelastpost' => 'getTopic_Listener_UpdatelastpostService',
    ...
    /**
     * Gets the 'discutea.forum.form.remove.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Discutea\DForumBundle\Form\Type\Remover\RemoveCategoryType A Discutea\DForumBundle\Form\Type\Remover\RemoveCategoryType instance
     */
    protected function getDiscutea_Forum_Form_Remove_CategoryService()
    {
        return $this->services['discutea.forum.form.remove.category'] = new \Discutea\DForumBundle\Form\Type\Remover\RemoveCategoryType($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'discutea.forum.form.remove.forum' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Discutea\DForumBundle\Form\Type\Remover\RemoveForumType A Discutea\DForumBundle\Form\Type\Remover\RemoveForumType instance
     */
    protected function getDiscutea_Forum_Form_Remove_ForumService()
    {
        return $this->services['discutea.forum.form.remove.forum'] = new \Discutea\DForumBundle\Form\Type\Remover\RemoveForumType($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'discutea.forum.pagin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Discutea\DForumBundle\Component\Pagin A Discutea\DForumBundle\Component\Pagin instance
     */
    protected function getDiscutea_Forum_PaginService()
    {
        return $this->services['discutea.forum.pagin'] = new \Discutea\DForumBundle\Component\Pagin($this->get('request_stack'), $this->get('knp_paginator'), array('page_name' => 'p', 'topics' => array('enabled' => true, 'per_page' => 10), 'posts' => array('enabled' => true, 'per_page' => 10)), 'p');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addResolveTargetEntity('Symfony\\Component\\Security\\Core\\User\\UserInterface', 'AppBundle\\Entity\\User', array());

        $d = new \Gedmo\Sluggable\SluggableListener();
        $d->setAnnotationReader($this->get('annotation_reader'));

        $e = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $e->addEventSubscriber($c);
        $e->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater')));
        ...
        $e->addEventListener(array(0 => 'postPersist', 1 => 'postRemove'), $this->get('topic.listener.updatelastpost'));
        $e->addEventListener(array(0 => 'preRemove'), $this->get('forum.listener.dropauser'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'orion-4.2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $e, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\discutea\\forum-bundle\\Discutea\\DForumBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Orion\\EventBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Orion\\ForumBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'Discutea\\DForumBundle\\Entity');
        $c->addDriver($b, 'Orion\\EventBundle\\Entity');
        $c->addDriver($b, 'Orion\\ForumBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'DForumBundle' => 'Discutea\\DForumBundle\\Entity', 'OrionEventBundle' => 'Orion\\EventBundle\\Entity', 'OrionForumBundle' => 'Orion\\ForumBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8bb0bef53e09be6099872f3382b2f04400eb6ce48f77969069f0f4c78aca2aa6');
    ...
    /**
     * Gets the 'forum.listener.dropauser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Discutea\DForumBundle\EventListener\ForumListener A Discutea\DForumBundle\EventListener\ForumListener instance
     */
    protected function getForum_Listener_DropauserService()
    {
        return $this->services['forum.listener.dropauser'] = new \Discutea\DForumBundle\EventListener\ForumListener();
    }
    ...
    protected function getKnpPaginatorService()
    {
        ...
        $instance->setDefaultPaginatorOptions(array('pageParameterName' => 'p', 'sortFieldParameterName' => 'sort', 'sortDirectionParameterName' => 'direction', 'filterFieldParameterName' => 'filterField', 'filterValueParameterName' => 'filterValue', 'distinct' => true));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 3));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/home_page', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    /**
     * Gets the 'topic.listener.updatelastpost' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Discutea\DForumBundle\EventListener\UpdateTopic A Discutea\DForumBundle\EventListener\UpdateTopic instance
     */
    protected function getTopic_Listener_UpdatelastpostService()
    {
        return $this->services['topic.listener.updatelastpost'] = new \Discutea\DForumBundle\EventListener\UpdateTopic();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Discutea\DForumBundle\Twig\DForumExtension($this->get('doctrine.orm.default_entity_manager'), $e, array('page_name' => 'p', 'topics' => array('enabled' => true, 'per_page' => 10), 'posts' => array('enabled' => true, 'per_page' => 10))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\discutea\\forum-bundle\\Discutea\\DForumBundle/Resources/views'), 'DForum');
        $instance->addPath(($this->targetDirs[3].'\\src\\Orion\\EventBundle/Resources/views'), 'OrionEvent');
        $instance->addPath(($this->targetDirs[3].'\\src\\Orion\\ForumBundle/Resources/views'), 'OrionForum');
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $instance->setVoters(array(0 => new \Discutea\DForumBundle\Security\PostVoter($instance), 1 => new \Discutea\DForumBundle\Security\TopicVoter($instance), 2 => new \Discutea\DForumBundle\Security\CategoryVoter($instance), 3 => new \Discutea\DForumBundle\Security\ForumVoter($instance), 4 => new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter(new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage(), $a, $b), 5 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($b), 6 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($a)));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(), 'ROLE_MODERATOR' => array(0 => 'ROLE_USER', 1 => 'ROLE_MODERATOR'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DForumBundle' => 'Discutea\\DForumBundle\\DForumBundle',
                'OrionEventBundle' => 'Orion\\EventBundle\\OrionEventBundle',
                'OrionForumBundle' => 'Orion\\ForumBundle\\OrionForumBundle',
            ...
            'discutea_forum.pagination' => array(
                'page_name' => 'p',
                'topics' => array(
                    'enabled' => true,
                    'per_page' => 10,
            ...
            'discutea_forum.pagination.pagename' => 'p',
            'discutea_forum.preview' => true,
