 ...
 */
class Billet extends \Orion\EventBundle\Entity\Billet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'id', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'libelle', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'type', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'prix', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'nombre', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'attente', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'evenement', '' . "\0" . 'Orion\\EventBundle\\Entity\\Billet' . "\0" . 'dateCreation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Billet $proxy) {
