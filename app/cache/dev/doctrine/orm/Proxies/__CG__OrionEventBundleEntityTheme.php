 ...
 */
class Theme extends \Orion\EventBundle\Entity\Theme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'id', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'libelle', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'description', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'etat', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'dateCreation', '' . "\0" . 'Orion\\EventBundle\\Entity\\Theme' . "\0" . 'dateModification'];
        }
