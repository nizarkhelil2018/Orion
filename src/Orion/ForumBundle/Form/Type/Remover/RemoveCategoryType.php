<?php
namespace Orion\ForumBundle\Form\Type\Remover;
...
class RemoveCategoryType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('purge', CheckboxType::class, array(
                'label'    => 'orion.forum.category.removeall.label',
                'required' => false,
            ))
        ;
    }
    ...
    private function getAllCategories() {
        $categories = $this->em->getRepository('OrionForumBundle:Category')->findBy(array(), array('position' => 'asc', ));
